...
public class BEE_1008{
    public static void main(String[] args) throws IOException{
        try (Scanner ler = new Scanner(System.in)) {    //Criando um scanner para ler inputs
            int N, Hrs;             //Declarando variáveis
            float Valor;
            N = ler.nextInt();      //Lendo inputs com scanner e atribuindo nas respectivas variáveis
            Hrs = ler.nextInt();
            Valor = ler.nextFloat();

...
A = float(input(''))        #recebe o input do usuário e atribui em A
B = float(input(''))        #recebe o input do usuário e atribui em B

print("MEDIA = " + str("{:.5f}".format(((3.5*A)+(7.5*B))/11 ,5)))   #Realizando o cálculo e exibindo a média
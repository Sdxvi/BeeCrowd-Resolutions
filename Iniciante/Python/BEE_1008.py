...
N = int(input(''))              #recebendo os valores das variáveis
Hrs = int(input(''))
Valor = float(input(''))

print("NUMBER =",N)             #exibindo NUMBER
print("SALARY = U$",  str("{:.2f}".format(Hrs * Valor)))       #Calculando e exibindo o valor recebido  